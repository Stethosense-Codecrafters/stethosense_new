    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('calories', models.FloatField(blank=True, help_text='Daily calorie requirements', null=True)),
                ...
                ('blood_pressure', models.CharField(blank=True, help_text='Blood Pressure', max_length=15, null=True)),
                ('blood_glucose', models.DecimalField(blank=True, decimal_places=2, help_text='Blood Glucose Level', max_digits=5, null=True)),
                ('cholesterol', models.JSONField(blank=True, help_text='Cholesterol Levels (JSON)', null=True)),
